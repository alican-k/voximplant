...
export const ForgotPasswordButton = ({ handler }) => <TextButton title='Forgot Password?' handler={handler} />
export const DontHaveAccountButton = ({ handler }) => <TextButton title="Don't have an account yet? Sign up now" handler={handler} />
export const HaveAccountButton = ({ handler }) => <TextButton title="I have an account. Sign in" handler={handler} />
