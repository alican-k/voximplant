...
class OutgoingIndex extends React.Component {
	constructor() {
		super()
    ...
    render() {
		const callInfo = this.props.call.call 
			? this.props.call.call.state === 'PROGRESSING'
				? 'Calling'
				: formatDuration(this.props.call.duration)
			: 'Ended'
